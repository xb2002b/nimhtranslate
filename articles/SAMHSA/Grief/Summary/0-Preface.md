...
Substance Abuse and Mental Health Services Administration: Strengthening Mental Health and Resilience After Community Violence: A Summary of Lessons Learned From ReCAST. Publication No. PEP24-01-009, Substance Abuse and Mental Health Services Administration, 2024.

> 译者注：引用原文请采用这种格式，引用译文另外注明本项目 GitHub 仓库链接即可。

## 联系方式与篇目相关信息

Center for Mental Health Services, Substance Abuse and Mental Health Services Administration, 5600 Fishers Lane, Rockville, MD 20857. SAMHSA Publication No. PEP24-01-009. Released 2024

## 网络链接

你可以在 [https://store.samhsa.gov](https://store.samhsa.gov) 下载相关文档。

## 免责声明

本文档中的所有内容均不构成对 SAMHSA、HHS 及任何非联邦机构的产品、服务、政策的，直接或非直接的支持。文中采用的图片，其著作权归属于 ©Getty Images, 2024，仅作为解释插图使用。图片中的人物仅作为模特出场。

## 公共领域说明

本文中出现的所有材料均处在公共领域，不经 SAMHSA 准许即可复制或演绎，但鼓励在复制或演绎时附上引用参考。但若涉及商用复制与演绎，则必须取得 SAMHSA 通讯办的书面允许。
