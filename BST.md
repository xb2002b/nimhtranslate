...
> 物理治疗用于应对重性精神障碍。这些疗法通常适用于情况危急的患者，比如失去和外界的联系或伤害自己。  
...
电流脉冲的频率即每次电刺激的时长，单位是毫秒。现代 ECT 可通过更短的脉冲发送电信号。这些短脉冲和传统 ECT 一样有效，但电流更小，因此失忆等副作用也更小。
...
一项[系统评价与荟萃分析](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8380249/)指出，相较于 ECT，MST 导致失忆等其他认知方面副作用的几率更小，治疗后的意识模糊和抽搐也比前者要更少出现，持续时间也更短。
